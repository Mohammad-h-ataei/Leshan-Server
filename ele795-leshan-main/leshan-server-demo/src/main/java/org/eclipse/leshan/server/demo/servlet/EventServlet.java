...
public class EventServlet extends EventSourceServlet
{
    ...
    private final ObservationListener observationListener = new ObservationListener()
    {
        ...
        public void onError(Observation observation, Registration registration, Exception error)
        {
            ...
            {
                LOG.warn(String.format("Unable to handle notification of [%s:%s]", observation.getRegistrationId(), observation.getPath()), error);
            }
        }
    ...
    public EventServlet(LeshanServer server, int securePort, PostmanServlet postmanServlet)
    {
        ...
        this.postmanServlet = postmanServlet;
