...
public class LeshanServerDemo {
    ...
    public static void createAndStartServer(String webAddress, int webPort, String localAddress, Integer localPort,
        ...
        // Creates Postman Thread
        PostmanServlet postmanServlet = new PostmanServlet();
        Thread t = new Thread(postmanServlet, "Postman thread");
        t.start();

        // Create Servlet
        EventServlet eventServlet = new EventServlet(lwServer, lwServer.getSecuredAddress().getPort(), postmanServlet);
